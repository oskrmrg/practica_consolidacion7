...
const datos_cursos = {
    ...
    actions:{
        consultarCursos:(context) => {
            // Actions si el archivo JSON se encuentra guardado en la carpeta "public"
            ...
            // Actions si el archivo JSON se encuentra alojado en json-server
            // hay que guardar el archivo json en una carpeta, y luego levantar el servidor desde consola
            // con el comando= [ json-server --watch (nombre_archivo).json ]
